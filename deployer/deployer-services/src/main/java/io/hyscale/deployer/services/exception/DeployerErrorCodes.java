...
import com.github.srujankujmar.commons.exception.HyscaleErrorGroup;
...
public enum DeployerErrorCodes implements HyscaleError {
    ...
    FAILED_TO_CREATE_RESOURCE("Failed to create resource {}",HyscaleErrorGroup.DEPLOYER_APPLY),
