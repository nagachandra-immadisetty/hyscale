...
public class DiagnosisReportUtil {
    ...
    public static DiagnosisReport getServiceNotDeployedReport(String serviceName) {
        DiagnosisReport report = new DiagnosisReport();
        report.setReason(AbstractedErrorMessage.SERVICE_NOT_DEPLOYED.formatReason(serviceName));
