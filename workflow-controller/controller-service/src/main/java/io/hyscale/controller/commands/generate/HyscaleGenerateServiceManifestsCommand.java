 ...
 *  profile - profile name to look for. Profile file should be present for all services in service spec
 ...
 * to to {@literal<USER.HOME>}/hyscale/apps/{@literal<appName>}/{@literal<serviceName>}/generated-files/manifests/
